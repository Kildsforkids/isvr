...
namespace ISVR.Utils {
    ...
    public class OneWayBoxCollider : MonoBehaviour {
        ...
        [SerializeField] private bool globalDirection = false;
        ...
        public Vector3 Direction => globalDirection ? entryDirection.normalized : transform.TransformDirection(entryDirection.normalized);
        ...
        private void OnDrawGizmosSelected()
        {
            ...
            Gizmos.DrawRay(transform.TransformPoint(collider.center), Direction * gizmoScale);
